...
const s = {
  ...
  locationInput: { padding: '6px 10px', borderRadius: 8, border: '1px solid var(--border-strong)', fontSize: 13, fontFamily: 'inherit', background: 'var(--surface-2)', color: 'var(--text-primary)', flex: 1, minWidth: 120 },
  ...
  cancelBtn: { background: 'none', border: '1px solid var(--border-strong)', borderRadius: 8, padding: '6px 12px', fontSize: 12, cursor: 'pointer', fontFamily: 'inherit', color: 'var(--text-secondary)' },
  ...
  searchCard: { background: 'var(--surface-2)', border: '1px solid var(--border)', borderRadius: 16, padding: 20, marginBottom: 20, display: 'flex', flexDirection: 'column', gap: 10 },
  searchTitle: { fontSize: 15, fontWeight: 500, color: 'var(--text-primary)' },
  searchInput: { padding: '10px 14px', borderRadius: 10, border: '1px solid var(--border-strong)', fontSize: 14, fontFamily: 'inherit', background: 'var(--surface-2)', color: 'var(--text-primary)', outline: 'none' },
  searchSelect: { padding: '10px 12px', borderRadius: 10, border: '1px solid var(--border-strong)', fontSize: 14, fontFamily: 'inherit', background: 'var(--surface-2)', color: 'var(--text-primary)' },
  searchLabel: { fontSize: 12, color: 'var(--text-muted)', fontWeight: 500 },
  modeRow: { display: 'flex', gap: 8 },
  mode: { flex: 1, padding: '8px 4px', borderRadius: 10, border: '1px solid var(--border-strong)', background: 'var(--surface-1)', fontSize: 13, cursor: 'pointer', fontFamily: 'inherit', color: 'var(--text-primary)' },
  ...
  zipInput: { padding: '10px 14px', borderRadius: 10, border: '1px solid var(--border-strong)', fontSize: 14, fontFamily: 'inherit', background: 'var(--surface-2)', color: 'var(--text-primary)', outline: 'none' },
  ...
  browseBtn: { background: 'none', border: '1px solid var(--border-strong)', borderRadius: 10, padding: '12px 16px', fontSize: 14, cursor: 'pointer', fontFamily: 'inherit', color: 'var(--text-primary)' },
  ...
  listingCard: { display: 'flex', gap: 12, alignItems: 'center', background: 'var(--surface-2)', border: '1px solid var(--border)', borderRadius: 12, padding: 12, cursor: 'pointer' },
  ...
  quickLink: { background: 'none', border: '1px solid var(--border-strong)', borderRadius: 10, padding: '10px 14px', fontSize: 13, cursor: 'pointer', fontFamily: 'inherit', color: 'var(--text-primary)' },
