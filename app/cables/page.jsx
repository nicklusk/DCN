...
const s = {
  ...
  search: { width: '100%', padding: '10px 14px', borderRadius: 10, border: '1px solid var(--border-strong)', fontSize: 14, fontFamily: 'inherit', outline: 'none', marginBottom: 12, background: 'var(--surface-2)', color: 'var(--text-primary)' },
  chips: { display: 'flex', gap: 6, flexWrap: 'wrap', marginBottom: 20 },
  chip: { fontSize: 12, padding: '5px 14px', borderRadius: 20, border: '1px solid var(--border-strong)', background: 'var(--surface-2)', cursor: 'pointer', fontFamily: 'inherit', color: 'var(--text-primary)' },
  ...
  catLabel: { fontSize: 11, fontWeight: 600, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: '0.06em', margin: '20px 0 10px' },
  list: { display: 'flex', flexDirection: 'column', gap: 8 },
  card: { background: 'var(--surface-2)', border: '1px solid var(--border)', borderRadius: 12, padding: 14, cursor: 'pointer' },
  cardOpen: { border: '1px solid var(--border-strong)' },
  cardTop: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: 10 },
  cardInfo: { flex: 1 },
  cardName: { fontSize: 15, fontWeight: 500, marginBottom: 3, color: 'var(--text-primary)' },
  cardSub: { fontSize: 13, color: 'var(--text-secondary)', marginBottom: 8, lineHeight: 1.4 },
  badge: { fontSize: 11, padding: '2px 8px', borderRadius: 20, fontWeight: 500 },
  expand: { marginTop: 14, paddingTop: 14, borderTop: '1px solid var(--border)', display: 'flex', flexDirection: 'column', gap: 12 },
  ...
  detailVal: { fontSize: 14, color: 'var(--text-secondary)', lineHeight: 1.5 },
  ...
  empty: { textAlign: 'center', color: 'var(--text-secondary)', padding: '40px 0', fontSize: 15 },
}