...
const s = {
  ...
  chip: { fontSize: 12, padding: '5px 14px', borderRadius: 20, border: '1px solid #e5e5e5', background: '#fff', cursor: 'pointer', fontFamily: 'inherit', color: '#555' },
  ...
  cardSub: { fontSize: 13, color: '#666', marginBottom: 8, lineHeight: 1.4 },
